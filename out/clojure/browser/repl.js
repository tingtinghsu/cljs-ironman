...
var seq__1819_1823 = cljs.core.seq.call(null,clojure.browser.repl.print_queue);
var chunk__1820_1824 = null;
var count__1821_1825 = (0);
var i__1822_1826 = (0);
while(true){
if((i__1822_1826 < count__1821_1825)){
var str_1827 = cljs.core._nth.call(null,chunk__1820_1824,i__1822_1826);
clojure.browser.net.transmit.call(null,conn,new cljs.core.Keyword(null,"print","print",1299562414),goog.json.serialize(({"repl": clojure.browser.repl._STAR_repl_STAR_, "str": str_1827})));


var G__1828 = seq__1819_1823;
var G__1829 = chunk__1820_1824;
var G__1830 = count__1821_1825;
var G__1831 = (i__1822_1826 + (1));
seq__1819_1823 = G__1828;
chunk__1820_1824 = G__1829;
count__1821_1825 = G__1830;
i__1822_1826 = G__1831;
continue;
} else {
var temp__5753__auto___1832 = cljs.core.seq.call(null,seq__1819_1823);
if(temp__5753__auto___1832){
var seq__1819_1833__$1 = temp__5753__auto___1832;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__1819_1833__$1)){
var c__4556__auto___1834 = cljs.core.chunk_first.call(null,seq__1819_1833__$1);
var G__1835 = cljs.core.chunk_rest.call(null,seq__1819_1833__$1);
var G__1836 = c__4556__auto___1834;
var G__1837 = cljs.core.count.call(null,c__4556__auto___1834);
var G__1838 = (0);
seq__1819_1823 = G__1835;
chunk__1820_1824 = G__1836;
count__1821_1825 = G__1837;
i__1822_1826 = G__1838;
continue;
} else {
var str_1839 = cljs.core.first.call(null,seq__1819_1833__$1);
clojure.browser.net.transmit.call(null,conn,new cljs.core.Keyword(null,"print","print",1299562414),goog.json.serialize(({"repl": clojure.browser.repl._STAR_repl_STAR_, "str": str_1839})));


var G__1840 = cljs.core.next.call(null,seq__1819_1833__$1);
var G__1841 = null;
var G__1842 = (0);
var G__1843 = (0);
seq__1819_1823 = G__1840;
chunk__1820_1824 = G__1841;
count__1821_1825 = G__1842;
i__1822_1826 = G__1843;
continue;
}
} else {
}
...
var script__$1 = (function (){var G__1848 = script;
goog.object.set(G__1848,"type","text/javascript");

goog.object.set(G__1848,"onload",onload);

goog.object.set(G__1848,"onreadystatechange",onload);

return G__1848;
})();
if((opt_sourceText == null)){
var G__1849 = script__$1;
goog.object.set(G__1849,"src",src);

return G__1849;
} else {
var G__1850 = script__$1;
goog.dom.setTextContent(G__1850,opt_sourceText);
...
var path_1851 = goog.debugLoader_.getPathFromDeps_(src);
goog.object.remove(goog.debugLoader_.written_,path_1851);

goog.object.remove(goog.debugLoader_.written_,[cljs.core.str.cljs$core$IFn$_invoke$arity$1(goog.basePath),cljs.core.str.cljs$core$IFn$_invoke$arity$1(path_1851)].join(''));
} else {
var path_1852 = goog.object.get(goog.dependencies_.nameToPath,src);
goog.object.remove(goog.dependencies_.visited,path_1852);

goog.object.remove(goog.dependencies_.written,path_1852);

goog.object.remove(goog.dependencies_.written,[cljs.core.str.cljs$core$IFn$_invoke$arity$1(goog.basePath),cljs.core.str.cljs$core$IFn$_invoke$arity$1(path_1852)].join(''));
}
} else {
}
...
return clojure.browser.net.transmit.call(null,repl_connection,new cljs.core.Keyword(null,"send-result","send-result",35388249),goog.json.serialize(({"repl": repl, "result": (function (){var _STAR_repl_STAR__orig_val__1853 = clojure.browser.repl._STAR_repl_STAR_;
var _STAR_repl_STAR__temp_val__1854 = repl;
(clojure.browser.repl._STAR_repl_STAR_ = _STAR_repl_STAR__temp_val__1854);

try{return clojure.browser.repl.evaluate_javascript.call(null,repl_connection,form);
}finally {(clojure.browser.repl._STAR_repl_STAR_ = _STAR_repl_STAR__orig_val__1853);
}})()})));
}));
